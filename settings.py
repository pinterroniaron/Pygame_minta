level_map: list[str] = [
    ...
    "HHHHHHHH                                                   FF                                XXXX     GG      G   X                                                   XXSSS       S     SS                                           ",
    "HHHHHHHH                                            H                  HHgGGGG                        XX      X                                                  G    X           S                                             ",
    "HHHHHHHH                                        H   F                  FFDXXXX      GG                                                                        G  X   GX           SST                                                   ",
    "HHHHHHHH                                        F                  HH  XXXXXXX      XX       GGGG                                                          G  X      XX  TT    TSSSSS    TT                                                 ",
    "HHHHHHHH             H           HH     HH                         FF                        XXXX                          GGG                          G  X         XX  S     SSSS     SS                                                  ",
    "HHHHHHHH           HHHHH       FFFF     FF                    HHH                            XXXX                  GGG     XXX                       G  X            XX  S    TSSSS                                             ",
